...
RM=rm -rf
OBJS=main.o input.o input_handlers.o input_handle_loop.o input_util.o transform.o colors.o julia.o mandelbrot.o fractals.o misc.o julia3.o juliasqrt.o carpet.o
NAME=fractol
LIBFT=libft
